...
public class Experiment2 {
	...
	// 结果集传送
	private static Res_send recv_http_h(BufferedReader reader, InputStream is, OutputStream os, Socket socket) throws NumberFormatException, IOException {
	...
	// 根据url下载文件
	private static String url_download(String sourceURL, String domainName, String uri,String destLoc) throws IOException {
	...
	// 文件流写入
	private static String file_write(String sourceURL, Socket socket, int bias, String contentType, String destLoc) throws IOException {
